...
If the compiler does not find an implicit instance matching the queried type T in the lexical scope,
...
At any point in a program, one can query an implicit value of a given type by
