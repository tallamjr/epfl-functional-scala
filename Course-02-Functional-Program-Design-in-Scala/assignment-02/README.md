...
Given this, you can now define a method isStanding which tells us whether the Block is standing or
not:
...
Then, implement a function neighborsWithHistory, which, given a block, and its history, returns a
